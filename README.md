...
**Project**: grimoire-gab-grove 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Make Grimoire an ai chat + coding app 
...
```sh
git clone https://github.com/GPT-Engineer-App/grimoire-gab-grove.git
cd grimoire-gab-grove
npm i
